@extends('layouts.app')
@section('title', 'Novo Usuário — CelestaSupply')
...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <h1 class="cs-page-title mb-0">Novo Usuário</h1>
</div>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <select name="role" class="form-select @error('role') is-invalid @enderror" required>
                    ...
                    <option value="requester" {{ old('role') === 'requester' ? 'selected' : '' }}>Solicitante</option>
