...
<div class="auth-container">
    ...
    <div class="auth-left">
        ...
        <div class="auth-left-inner">
            ...
            <div class="auth-left-title">Recuperação<br>de Acesso</div>
            <div class="auth-left-desc">Enviaremos um link seguro para o seu e-mail cadastrado para redefinir sua senha.</div>
        </div>
    ...
    <div class="auth-right">
        <div class="auth-form-wrap">
            ...
            <div class="auth-heading">Esqueceu sua senha?</div>
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="s1" style="margin-bottom:24px">
