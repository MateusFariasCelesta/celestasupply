...
<head>
    ...
    <title>Redefinir Senha — CelestaSupply</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .divider { border: none; border-top: 1px solid #E5EBF5; margin: 28px 0 22px; }
        ...
        @media (max-width: 768px) {
            ...
            .auth-left { width: 100%; min-height: auto; padding: 28px 24px; animation: none; }
...
<div class="auth-container">
    ...
    <div class="auth-left">
        ...
        <div class="auth-left-inner">
            ...
            <div class="auth-left-title">Nova Senha</div>
            <div class="auth-left-desc">Escolha uma senha forte e segura para proteger sua conta no sistema.</div>
        </div>
    ...
    <div class="auth-right">
        <div class="auth-form-wrap">
            ...
            <div class="auth-subheading">Escolha uma nova senha para sua conta. Use ao menos 8 caracteres.</div>
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="s1" style="margin-bottom:20px">
                ...
                <div class="s3" style="margin-bottom:28px">
